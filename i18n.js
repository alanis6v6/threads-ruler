...
(function(){
  ...
  var T = {
    ...
    // 贊助與意見回饋
    "這個工具是免費的": ["This tool is free", "このツールは無料です", "이 도구는 무료예요"],
    "如果它幫你省下一點排版的時間，可以請我喝杯飲料 ♡ 不贊助也完全沒關係，功能不會有任何差別。": ["If it saved you some formatting time, you can buy me a drink ♡ Not supporting is totally fine too — nothing about the tool changes.", "レイアウトの時間を少し節約できたなら、よかったら一杯おごってください ♡ 支援しなくても全く問題ありません。機能は何も変わりません。", "꾸미는 시간을 조금이라도 아꼈다면 음료 한 잔 사 주셔도 좋아요 ♡ 후원하지 않아도 전혀 괜찮고, 기능은 똑같아요."],
    "綠界（台灣超商、轉帳）": ["ECPay (Taiwan)", "ECPay（台湾）", "ECPay (대만)"],
    "用起來卡卡的嗎？": ["Something not working right?", "使いにくいところはありますか？", "쓰다가 불편한 점이 있나요?"],
    "想要什麼功能、哪裡怪怪的、或是排版排到一半卡住，都可以跟我說。不用留名字。": ["Tell me what you'd like added, what looks off, or where you got stuck. No name needed.", "欲しい機能、おかしいところ、途中で詰まったところ、何でも教えてください。名前は不要です。", "원하는 기능, 이상한 부분, 중간에 막힌 곳 무엇이든 알려 주세요. 이름은 안 남겨도 돼요."],
    "✉️ 告訴我": ["✉️ Tell me", "✉️ 教える", "✉️ 알려주기"],
    "回饋類型": ["Feedback type", "フィードバックの種類", "피드백 종류"],
    "想要新功能": ["Feature request", "機能のリクエスト", "기능 요청"],
    "回報問題": ["Report a problem", "不具合の報告", "문제 신고"],
    "只是想說聲謝謝": ["Just saying thanks", "お礼を言いたいだけ", "그냥 고맙다는 말"],
    "其他": ["Other", "その他", "기타"],
    "想說的話…": ["What's on your mind…", "伝えたいこと…", "하고 싶은 말…"],
    "想說的話": ["Your message", "伝えたいこと", "하고 싶은 말"],
    "想收到回覆的話，留個翠帳號或 email（選填）": ["Want a reply? Leave a Threads handle or email (optional)", "返信が欲しい場合は、Threadsのアカウントかメールを（任意）", "답장을 원하면 스레드 계정이나 이메일을 남겨 주세요(선택)"],
    "聯絡方式（選填）": ["Contact (optional)", "連絡先（任意）", "연락처(선택)"],
    "送出": ["Send", "送信", "보내기"],
    "送出中…": ["Sending…", "送信中…", "보내는 중…"],
    "送出的內容會存進作者自己的 Google 試算表，只有作者看得到。你在排版尺裡打的草稿不會一起送出。": ["What you send is saved to the author's own Google Sheet and only the author can see it. The draft you typed in the ruler is not sent.", "送信した内容は作者自身のGoogleスプレッドシートに保存され、作者だけが見られます。ルーラーに入力した下書きは送信されません。", "보낸 내용은 제작자 본인의 Google 스프레드시트에 저장되며 제작자만 볼 수 있어요. 룰러에 입력한 초안은 함께 전송되지 않아요."],
    "再多寫一點點，我才知道怎麼幫你 ˊ_>ˋ": ["A little more detail, so I know how to help ˊ_>ˋ", "もう少しだけ詳しく書いてもらえると助かります ˊ_>ˋ", "조금만 더 써 주면 도와주기 좋아요 ˊ_>ˋ"],
    "謝謝你，我收到了！": ["Thank you, got it!", "ありがとう、受け取りました！", "고마워요, 잘 받았어요!"],
    "剛剛才送出過，等一下下再試 ˊ_>ˋ": ["You just sent one — give it a moment ˊ_>ˋ", "さっき送ったばかりです。少し待ってね ˊ_>ˋ", "방금 보냈어요. 잠시 후에 다시 시도해 주세요 ˊ_>ˋ"],
    "送不出去，可能是網路的關係，等一下再試一次 ˊ_>ˋ": ["Couldn't send — probably the network. Try again in a bit ˊ_>ˋ", "送信できませんでした。通信の問題かもしれません。少し後にもう一度試してください ˊ_>ˋ", "보내지 못했어요. 네트워크 문제일 수 있으니 잠시 후 다시 시도해 주세요 ˊ_>ˋ"],
    "✉️ 收到了，謝謝你！": ["✉️ Got it, thank you!", "✉️ 受け取りました、ありがとう！", "✉️ 잘 받았어요, 고마워요!"],
  };
